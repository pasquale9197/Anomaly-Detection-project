...
class MLP_UAI(BaseNet):
    def __init__(self, x_dim, h_dims=[128, 64], rep_dim=32, bias=False):
        ...
        self.reg = nn.Linear(rep_dim+1, 1, bias=True)  # regression
...
class MLP_Decoder(BaseNet):
    ...
    def __init__(self, x_dim, h_dims=[64, 128], rep_dim=32, bias=False):
        ...
        self.output_activation = nn.Sigmoid()  # For anomaly detection benchmarks, samples are standardized to N(0, 1)s
